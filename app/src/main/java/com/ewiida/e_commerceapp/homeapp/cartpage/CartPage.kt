...
import com.ewiida.e_commerceapp.homeapp.cartpage.orderdetails.OrderDetailsActivity
...
class CartPage : Fragment() {
    ...
    fun cartItemsRVHolder(){
        ...
        cartItems.add(element = CartItemDataClass(R.drawable.womanimage,"Roller Rabbit","Vado Odelle Dress",198))
        cartItems.add(element = CartItemDataClass(R.drawable.cotchie,"Axel Arigato","Clean 90 Triole Sneakers",245))
        cartItems.add(element = CartItemDataClass(R.drawable.backbag,"Herschel Supply Co.","Daypack Backpack",40))

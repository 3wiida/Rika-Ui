...
class CategoryAdapter(private var itemList : List<CategoryItem>) : RecyclerView.Adapter<CategoryAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(view : View) : RecyclerView.ViewHolder(view){
        var itemImage : ImageView = itemView.findViewById(R.id.categoryImage)
        var itemName : TextView = itemView.findViewById(R.id.categoryName)
        var itemDesc : TextView = itemView.findViewById(R.id.categoryDesc)
    }
